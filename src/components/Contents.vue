    ...
    <div class="contents-wrapper">
        ...
        <div class="contents">
            <div class="comics-content">
                <!-- <div class="comics-card" v-for="(element, index) in comicsList" :key=index>
                    <img :src="element.thumb" :alt="element.series">
                    <h3>{{element.series}}</h3>
                </div> -->

                <productCard v-for="(element, index) in comicsList" :key=index :thumb="element.thumb" :series="element.series" />
            </div>
        </div>
